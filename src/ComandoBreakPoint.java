...
public class ComandoBreakPoint {
	...
	public static void main(String[] args) {
		...
		// System.out.printf("%s tem %d anos e ganhar R$ %.2f reais.%n", nome, idade,
		// renda);
		/*
		 * %f = ponto flutuante %d = inteiro %s = string %n = quebra de linha %.2f
